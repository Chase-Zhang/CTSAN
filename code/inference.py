        ...
        with torch.no_grad():
            ...
            for v in videos:
                ...
                for in_seq, gt_seq in zip(input_seqs, gt_seqs):
                    ...
                    self.all_time += postprocess_time - start_time
                    self.n += 1
            print("avg time per frame=:", self.all_time/self.n)
            self.logger.write_log("# Total AVG-time={:.5}".format(self.all_time/self.n))
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='CTSAN-Inference') 
    ...
    parser.add_argument('--default_data', type=str, default='.',
                        help='quick test, optional: TiO, Dual, EarlyStop')
    parser.add_argument('--data_path', type=str, default='../dataset/test',
                        help='the path of test data')
    parser.add_argument('--model_path', type=str, default='../pretrain_models/CTSAN_DVD_Convergent.pt',
                        help='the path of pretrain model')
    parser.add_argument('--result_path', type=str, default='../infer_results',
                        help='the path of deblur result')
    args = parser.parse_args() 

    if args.default_data == 'TiO': 
        args.data_path = '../dataset/test/TiO'
        args.model_path = '../Trained_Model/CTSAN_TiO_Convergent.pt'
        args.result_path = '../infer_results/TiO'
    elif args.default_data == 'Dual':
        args.data_path = '../dataset/test/Dual'
        args.model_path = '../Trained_Model/CTSAN_dual_Convergent.pt'
        args.result_path = '../infer_results/dual'
    elif args.default_data == 'EarlyStop':
        args.data_path = '../dataset/test/656nm2'
        args.model_path = '../Trained_Model/CTSAN_656nm2_EarlyStop.pt'
        args.result_path = '../infer_results/656nm2'
